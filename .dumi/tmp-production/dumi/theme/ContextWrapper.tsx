...
export default function DumiContextWrapper() {
  ...
  return (
    <SiteContext.Provider value={{
      pkg: {"name":"hooks","description":"","version":"0.0.0","license":"MIT","repository":{"type":"git","url":"git+https://github.com/Loogeek/hooks.git"},"author":"Loogeek"},
      historyType: "browser",
      entryExports,
      demos,
      components,
      ...
      setLoading,
      hostname: undefined,
      themeConfig: {"footer":"Copyright © 2023 | Powered by <a href=\"https://d.umijs.org\" target=\"_blank\" rel=\"noreferrer\">dumi</a>","prefersColor":{"default":"light","switch":true},"nprogress":true,"name":"hooks"},
